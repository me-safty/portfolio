    ...
    <div className={cn("flex flex-wrap gap-4", className)}>
      {displayedSocials.map((social) => (
        <a
          ...
          className="group flex items-center gap-3 px-5 py-3 bg-muted/30 border border-border hover:border-primary hover:bg-primary/5 transition-all duration-300 min-w-[140px]"
        >
          <span className="text-muted-foreground group-hover:text-primary transition-colors">
            {socialIcons[social.icon] || socialIcons.github}
          </span>
          <div className="flex flex-col">
            <span className="text-xs font-mono text-muted-foreground/50 uppercase tracking-widest leading-none mb-1">Connect</span>
